...
def generate_llm_response(env, messages, processed_results):
    system_prompt = """
    You're an AI assistant that finds the only one best AI Agent to serve user's request. 
    ...
    If you find the agent that can help the user, provide the the following response:
    ```
    {
